...
// findAccountById(accounts, "5f446f2e365320cc6ed66535") 
/*************************************************** */
...
// console.log(getTotalNumberOfBorrows("5f446f2ed3609b719568a415", books))



/***************************************************** */
// It returns an array of book objects, including author information, that represents all books 
// _currently checked out_ by the given account. _Look carefully at the object below,_ as 
// it's not just the book object; the author object is nested inside of it.


function getBooksPossessedByAccount(account, books, authors) {
//look for the books that the account has borrowed
//check if books returned: false

//check if book is not borrowed and account is the same

let borrowedBook = books.reduce((acc, book)=>{
  let borrowHistory = []
  

  borrowHistory = 
    book.borrows.filter(borrow => (borrow.id === account && !borrow.returned))
  // console.log("if borrowed " + book.borrows)

  if(borrowHistory.length > 0){
    // book.push = borrowHistory;
    book["borrows"]=borrowHistory[0]
